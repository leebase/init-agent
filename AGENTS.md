...
You are assisting with **init-agent**, a Python Package project.
...
If you are an Antigravity agent, you must map your internal artifacts to this project's documentation system.
